...
public enum ErrorCode {
    ...
    PHONE_EXISTED(10016, "So dien thoai da ton tai" , HttpStatus.BAD_REQUEST),
    ...
    INVALID_ORDER_STATUS_TRANSITION(50006, "Khong the chuyen trang thai don hang" , HttpStatus.BAD_REQUEST),
    WISHLIST_ITEM_NOT_EXIST(70000, "Wishlist item khong ton tai" , HttpStatus.NOT_FOUND),
    VOUCHER_NOT_EXIST(70001, "Voucher khong ton tai" , HttpStatus.NOT_FOUND),
    VOUCHER_CODE_EXISTED(70002, "Voucher code da ton tai" , HttpStatus.BAD_REQUEST),
    VOUCHER_NOT_AVAILABLE(70003, "Voucher khong kha dung" , HttpStatus.BAD_REQUEST),
    ...
    CARRIER_NOT_EXIST(60007, "Carrier khong ton tai" , HttpStatus.NOT_FOUND),
    CARRIER_ASSIGNMENT_NOT_EXIST(60008, "Carrier assignment khong ton tai" , HttpStatus.NOT_FOUND),
